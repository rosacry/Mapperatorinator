    ...
    Args:
        ...
        decoder_input_ids (`torch.LongTensor` of shape `(batch_size, target_sequence_length)`, *optional*):
            ...
            [What are decoder input IDs?](../glossary#decoder-input-ids)
             ...
             NWhisper uses the `decoder_start_token_id` as the starting token for `decoder_input_ids` generation. If
...
class  NWhisperEncoder( NWhisperPreTrainedModel):
    ...
    def __init__(self, config: WhisperConfig):
        ...
        self.layers = nn.ModuleList([ NWhisperEncoderLayer(config) for _ in range(config.encoder_layers)])
...
class  NWhisperDecoder( NWhisperPreTrainedModel):
    ...
    def __init__(self, config: WhisperConfig):
        ...
        self.layers = nn.ModuleList(
            [ NWhisperDecoderLayer(config, layer_idx) for layer_idx in range(config.decoder_layers)]
        )
...
class  NWhisperForAudioClassification( NWhisperPreTrainedModel):
    ...
    def forward(
        ...
        >>> model =  NWhisperForAudioClassification.from_pretrained("sanchit-gandhi/whisper-medium-fleurs-lang-id")
