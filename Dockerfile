...
RUN pip install accelerate pydub nnAudio PyYAML transformers hydra-core tensorboard lightning 'git+https://github.com/OliBomby/slider.git@gedagedigedagedaoh#egg=slider' torch_tb_profiler wandb ninja
